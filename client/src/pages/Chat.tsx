...
export default function Chat() {
  ...
  const { data: messages = [], isLoading: isLoadingMessages } = useQuery<ChatMessage[]>({
    ...
    queryFn: () => apiRequest(`/api/chat/${sessionId}`, 'GET'),
    enabled: !!sessionId
  });
  ...
  const sendMessageMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      // Invalidate both old and new session keys
      queryClient.invalidateQueries({ queryKey: ['/api/chat', oldSessionId] });
      if (data.sessionId && data.sessionId !== oldSessionId) {
